...
const CARDS = [
  {
    ...
    accent: '#16A34A', accentLight: '#DCFCE7', accentBorder: '#BBF7D0',
    requiresLogin: true,
  },
  {
    role: 'it_staff',
  ...
  },
  {
    ...
    accent: '#7C3AED', accentLight: '#EDE9FE', accentBorder: '#DDD6FE',
    requiresLogin: false,
  },
];
    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          .landing-grid { grid-template-columns: 1fr; max-width: 380px; }
        }
      ...
      <div className="landing-root">
        <div className="landing-inner">
          ...
          {/* Heading */}
          <h1 style={{ fontSize: '32px', fontWeight: '800', color: '#0F172A', margin: '0 0 10px', letterSpacing: '-0.5px', lineHeight: 1.2, textAlign: 'center' }}>
            Welcome — who are you?
          </h1>
          <p style={{ fontSize: '16px', color: '#64748B', margin: '0 0 48px', lineHeight: 1.6, textAlign: 'center' }}>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    boxShadow: isHovered
                      ? `0 16px 48px rgba(0,0,0,0.14), 0 0 0 4px ${card.accentBorder}`
                ...
                >
                  ...
                  <div style={{ fontSize: '13px', color: '#64748B', lineHeight: 1.65, marginBottom: '24px', flex: 1 }}>
                    {card.description}
                  </div>
