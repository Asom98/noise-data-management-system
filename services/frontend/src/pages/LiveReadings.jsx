  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <h1 style={{ fontSize: '22px', fontWeight: '700', color: '#111827', margin: 0 }}>Live Readings</h1>
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginTop: '6px' }}>
            <div style={{
              width: '8px', height: '8px', borderRadius: '50%',
              backgroundColor: '#10B981', animation: 'pulse 2s infinite',
            }} />
            <span style={{ fontSize: '13px', color: '#6B7280' }}>Live updates — refreshing every 10 seconds</span>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <h3 style={{ fontSize: '15px', fontWeight: '600', color: '#111827', margin: '0 0 16px 0' }}>Reading Guidelines</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
          {[
            { label: 'Normal', range: '< 60 dB', color: '#10B981', bg: '#ECFDF5', desc: 'Safe ambient noise' },
            { label: 'Moderate', range: '60–70 dB', color: '#F59E0B', bg: '#FFFBEB', desc: 'Elevated but acceptable' },
            { label: 'High', range: '70–80 dB', color: '#F97316', bg: '#FFF7ED', desc: 'Approaching unsafe levels' },
            { label: 'Critical', range: '80+ dB', color: '#EF4444', bg: '#FEF2F2', desc: 'Immediate attention required' },
          ].map((g) => (
